package ru.shilov.testsecurity2dbthemeleaf.controller;
...
import ru.shilov.testsecurity2dbthemeleaf.service.UserService;
...
public class SecurityController {
    ...
    public String registration (@Valid @ModelAttribute ("user")
                                    UserDto userDto,
